...
summary: IJCAI-ECAI 2026 is launching the "Primary Paper Initiative", introducing a $100 USD submission fee. Are we really addressing the root cause, or just taxing it? Here is my take on it.
---
I recently read the news that IJCAI-ECAI 2026 is launching the "Primary Paper Initiative." They are introducing a $100 USD submission fee. This fee is waived only for "primary papers", meaning papers where none of the authors appear on any other submission.
...
Finally, I find the "reviewer workload" justification slightly ironic. Isn't everyone who submits already obligated to review? If the community is doing its part, why is the burden still so high? Furthermore, we are the AI community! Are we really saying we aren't advanced enough to utilize our own technology—AI—to assist with the first round of review or triage? It seems strange to charge human fees to solve a problem that our own research is trying to solve.
